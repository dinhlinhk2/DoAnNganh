...
namespace Demo.Areas.Admin.Controllers
{
    ...
    public class AdminAccountsController : Controller
    {
        ...
        public async Task<IActionResult> ChangePassAsync(int? id)
        {
            if (id == null || _context.Accounts == null)
            {
                return NotFound();
        ...
        // GET: Admin/AdminAccounts/ChangePass
        [HttpPost]
        public IActionResult ChangePass([Bind("AccountId,Email,PasswordNow")] ThayDoiPassViewModel model)
        {
            if (ModelState.IsValid)
            {
                var taikhoan = _context.Accounts.AsNoTracking()
